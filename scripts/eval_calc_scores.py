...
from auto_pose.bop_toolkit.bop_toolkit_lib import pose_matching
from auto_pose.bop_toolkit.bop_toolkit_lib import score
...
def eval_calc_scores(eval_args, eval_dir, filename):
  ...
  p['error_dir_paths'] = [f for f in os.listdir(filename.replace('.csv', ''))]
